...
class Scraper:
    def __init__(self, logger, utils, network_manager, url_builder, file_manager, salary_determiner):
        self.logger = logger
        self.utils = utils
    ...
    def start_scraping(self):
        try:
            ...
            self.logger.scraping_completed()
    ...
    def _process_page(self, url, page_number):
        try:
            ...
            self.file_manager.save_page_jobs([job for job in jobs if job is not None], page_number)
        except Exception as e:
